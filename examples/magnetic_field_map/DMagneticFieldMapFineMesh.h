...
#ifndef SURROGATE_TOOLKIT_DMAGNETICFIELDMAPFINEMESH_H
#define SURROGATE_TOOLKIT_DMAGNETICFIELDMAPFINEMESH_H
...
#endif //SURROGATE_TOOLKIT_DMAGNETICFIELDMAPFINEMESH_H
