...
// This is a hacked-up version of G4EmStandardPhysics, which delegates to
// PhasmProcess sometimes. A better long-term strategy might be either to do
// surgery on the process table directly, or to invoke G4's fast sim machinery.
...
//
G4_DECLARE_PHYSCONSTR_FACTORY(PhasmEmPhysics);

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

PhasmEmPhysics::PhasmEmPhysics(G4int ver, const G4String &)
...
PhasmEmPhysics::~PhasmEmPhysics() {}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void PhasmEmPhysics::ConstructParticle() {
...
void PhasmEmPhysics::ConstructProcess() {
  if (verboseLevel > 1) {
  ...
  // This is where the surgery happens, at least for now:
  //
  ph->RegisterProcess(
      new PhasmProcess(new G4eIonisation(),
                       PhasmProcess::MethodToSurrogate::AlongStepDoIt),
      particle);
...
//....oooOO0OOooo........oooOO1OOooo........oooOO0OOooo........oooOO0OOooo......
